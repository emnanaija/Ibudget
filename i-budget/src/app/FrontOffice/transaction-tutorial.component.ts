...
@Component({
  selector: 'app-transaction-tutorial',
  standalone: true,
...
export class TransactionTutorialComponent implements AfterViewInit {
  ...
  tutorialMessages: string[] = [
    "Welcome to Scheduled Transactions! Here you can track and manage all your upcoming payments with ease.",
    "Use the form on the right to schedule new transactions by picking a date, time, and amount.",
    "Watch the timeline update and stay informed as your scheduled transactions are processed!"
  ];
